...
def main():
    parser = argparse.ArgumentParser(description='This is a baseline for subtask1 influencer intent identification.')
    ...
    args.tokenizer_length = 150
    args.text_seq_length = 80
    if args.output is None:
        args.output = 'subtask1.json'
